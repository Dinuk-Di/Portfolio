...
const Experience = () => {
    ...
    return (
        <div className='my-48'>
            <AnimatedText text="PROFESSIONAL EXPERIENCE." className='font-black text-8xl w-full text-left md:text-6xl sm:!text-5xl xs:!text-4xl mb-24 md:mb-16 uppercase tracking-tighter' />
